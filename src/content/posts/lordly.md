...
The other thing with inputs is the HTML is a gigantic grad bag of everything that can possibly be used on it and sometimes it's not contextualy sensitive to what we're trying to do.
